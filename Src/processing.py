...
def get_sales_daily(file_path: str, date: str, master_file_path: str = "거래처마스터.xlsx") -> pd.DataFrame:
    """
    매출 데이터 처리 함수 (개선 버전)
...
def get_purchase_daily(file_path: str, date: str, master_file_path: str = "거래처마스터.xlsx") -> pd.DataFrame:
    """
    매입 데이터 처리 함수 (개선 버전)
